			...
			<div class="col-sm-8 col-sm-offset-2">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form method="post" action="insertReader.php" class="form-horizontal">
							<div class="form-group">
								<label for="rid" class="col-sm-3 control-label">Reader ID</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="rid" id="rid" required="required">
								</div>
							</div>
							<div class="form-group">
							...
							<button type="button" onclick="window.location.href='reader.php'" class="btn btn-default col-sm-offset-2 col-sm-2">Back</button>
						</form>
					</div>
				</div>
			</div>
